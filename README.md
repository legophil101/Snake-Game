...
A classic Snake game built in Python using the turtle module, featuring an OOP structure, smooth controls, and sound effects using pygame.
...
- Persistent high score saved locally (`data.txt` is auto-created on first run)
- Sound effects for eating and game over
